...
from kalshi.exceptions import ApiTypeError, ApiValueError, ApiException
from kalshi.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance.change_subscription  # this is an instance of the class Endpoint
        api_instance.change_subscription()  # this invokes api_instance.change_subscription.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.change_subscription.callable or self.callable in this class
