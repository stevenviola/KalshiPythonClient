...
class UserGetAccountHistoryResponse(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'entries': ([AccountHistoryEntry],),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, entries, *args, **kwargs):  # noqa: E501
        """UserGetAccountHistoryResponse - a model defined in OpenAPI

        Args:
            entries ([AccountHistoryEntry]): List of account history items for the user
